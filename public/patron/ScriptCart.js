...
const BROWSE_PAGE = "/patron/browsestalls.html";
const CART_PAGE = "/patron/cart.html";
...
function findNavCartLink() {
  return (
    document.querySelector('a.navlink[href="/patron/cart.html"]') ||
...
function bindNavigation() {
  ...
  document.getElementById("proceedCheckout")?.addEventListener("click", () => {
    ...
    window.location.href = "/patron/checkout.html";
  });
}
