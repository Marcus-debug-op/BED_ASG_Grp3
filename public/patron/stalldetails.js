...
async function loadDetails() {
    ...
    try {
        ...
        if (imgElement) {
            imgElement.src = normalizeImageUrl(s.image_url);
            imgElement.onerror = () => {
        ...
        const menuBtn = document.querySelector('a[href*="/patron/menus.html"]') || document.getElementById("menu-link");
        if (menuBtn) menuBtn.href = `/patron/menus.html?id=${encodeURIComponent(stallId)}`;
