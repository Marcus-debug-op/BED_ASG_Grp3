(() => {
  ...
  const PATRON_SIGNIN_PAGE = "/auth/SigninPatron.html"; 
  const VENDOR_SIGNIN_PAGE = "/auth/SignInVendor.html"; 

  const PATRON_SIGNUP_PAGE = "/auth/CreateAccountPatron.html"; 
  const VENDOR_SIGNUP_PAGE = "/auth/CreateAccountVendor.html"; 
